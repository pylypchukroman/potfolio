      ...
      <PhotoReveal className="shrink-0">
        <div className="group relative h-48 w-48 overflow-hidden rounded-2xl border border-border bg-card sm:h-56 sm:w-56">
          <Image
            ...
            fill
            sizes="224px"
            className="object-cover grayscale-0 transition-[filter] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] lg:grayscale lg:group-hover:grayscale-0 lg:group-focus-within:grayscale-0 motion-reduce:grayscale-0 motion-reduce:transition-none"
            priority
          />
        </div>
      </PhotoReveal>
